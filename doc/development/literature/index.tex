...
\newcommand{\paracite}[1]{\paragraph{\htmlanchorstart{bibentry:#1}\htmlspantitle{\usebibentry{#1}{title}}{\usebibentry{#1}{abstract}}~\citet{#1}}\label{bibentry:#1}\htmlanchorend{bibentry:#1}}
% \bibentry{#1}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% }}}
